...
function useGaiaSimulation() {
    ...
    // scenario save / load
    const saveScenario = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((name)=>{
...
function RealTimeGraph({ title = 'Series', color = '#2de8a7', data = [], height = 120 }) {
    ...
    // Simple SVG polyline renderer. Recalculates path when data changes.
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
...
function GaiaLink() {
    ...
    // simple derived series for graphs: update when inputs change
    const graphA = Array.from({
        length: 32
    }).map((_, i)=>({
            x: i,
            y: Math.max(0, (inputs.co2 || 50) + Math.sin(i / 6) * (inputs.pol ? -5 : 5))
        }));
    const graphB = Array.from({
        length: 32
    }).map((_, i)=>({
            x: i,
            y: Math.max(0, (inputs.ren || 50) + Math.cos(i / 5) * (inputs.def ? -4 : 4))
        }));
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        children: [
            ...
            city !== 'main' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$CityTab$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                    ...
                    baseImg: city === 'delhi' ? 'https://eoimages.gsfc.nasa.gov/images/imagerecords/79000/79548/delhi_2020.jpg' : city === 'mumbai' ? 'https://eoimages.gsfc.nasa.gov/images/imagerecords/76000/76821/mumbai_2020.jpg' : 'https://eoimages.gsfc.nasa.gov/images/imagerecords/7000/7436/darjeeling.jpg',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__111df35b._.js.map