...
"[project]/lib/geminiRetry.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$geminiRetry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/geminiRetry.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function GaiaLink() {
    ...
    async function runSimulation() {
        ...
        const prompt1 = `You are GAIA 2.0 — produce a concise simulation JSON block.

Inputs:
${JSON.stringify(inputs, null, 2)}

Return only a JSON object with the keys: \"index\", \"tempDrift\", \"biodiversity\", \"seaLevel\" and any additional helpful fields.`;
        try {
            const g = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$geminiRetry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["safeGemini"])(prompt1);
            ...
            console.warn('safeGemini returned no parseable JSON, falling back to API');
        } catch (err) {
            console.warn('safeGemini error, falling back to API', err?.message || err);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c318041f._.js.map