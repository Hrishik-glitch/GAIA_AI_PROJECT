...
function Nexus({ result }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (obs.length > 0) {
            const criticalCount = obs.filter((o)=>o.level === 'critical').length;
            const concernCount = obs.filter((o)=>o.level === 'concern').length;
            const goodCount = obs.filter((o)=>o.level === 'excellent' || o.level === 'good').length;
            const categories = [
                ...new Set(obs.map((o)=>o.type))
            ];
            // Build detailed observation list
            const observationDetails = obs.slice().reverse().map((o)=>{
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            gaiaTint ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                style: {
                                                    marginLeft: 'auto',
                                                    display: 'flex',
                                                    alignItems: 'center',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__de469829._.js.map